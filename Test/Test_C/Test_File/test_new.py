...
class TestNew(MyTest, Login, New, Delete, Search):
    def test_Person_TestNew_00(self):
        """进行操作之前，先保证我的文件是空的"""
    ...
    def test_Person_TestNew_01(self):
    ...
    def test_Person_TestNew_02(self):
    ...
    def test_Person_TestNew_03(self):
    ...
    def test_Person_TestNew_04(self):
        """新建文件夹，文件名：新建的文件夹"""
        self.login(account['username'], account['password'], login_type=1)  # 登录
        self.wait_element(self.my_file_loc)
        self.element_click(self.my_file_loc)  # 点击我的文件
