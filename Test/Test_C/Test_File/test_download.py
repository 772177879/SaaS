...
class TestDownload(MyTest, Login, New, Delete, Download):
    ...
    def test_Person_TestDownload_02(self):
        ...
        time.sleep(10)
        self.assertTrue(download_file_success('被下载的文件夹.zip'))  # 验证下载成功了
    ...
    def test_Person_TestDownload_03(self):
        ...
        time.sleep(10)
        self.assertTrue(download_file_success('pg下载的文件.pptx等4个文件.zip'))  # 验证下载成功了
        self.assertIn('ss下载的文件.xlsx', un_zip('pg下载的文件.pptx等4个文件.zip'))  # 验证文件在
        self.assertIn('wp下载的文件.docx', un_zip('pg下载的文件.pptx等4个文件.zip'))  # 验证文件在
        self.assertIn('pg下载的文件.pptx', un_zip('pg下载的文件.pptx等4个文件.zip'))  # 验证文件在
        self.assertIn('被下载的文件夹/', un_zip('pg下载的文件.pptx等4个文件.zip'))  # 验证文件在
        self.assertIn('被下载的文件夹/ss文件夹内部的文件.xlsx', un_zip('pg下载的文件.pptx等4个文件.zip'))  # 验证文件在
